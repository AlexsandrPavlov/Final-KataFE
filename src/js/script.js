...
const btn_message_close = document.querySelector(
	'.modal-message__btn-close'
);
const btn_call_dd = document.querySelector(
	'.dropdown-footer-button__call'
);
const btn_message_dd = document.querySelector(
	'.dropdown-footer-button__chat'
);
...
btn_call.addEventListener('click', function () {
	if (!modal_call.classList.contains('modal-call__active')) {
...
btn_message.addEventListener('click', function () {
	if (!modal_message.classList.contains('modal-message__active')) {
